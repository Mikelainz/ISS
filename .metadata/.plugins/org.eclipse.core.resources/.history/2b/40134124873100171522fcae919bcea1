...
public abstract class AbstractIotled extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractIotled(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/iotled/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/iotled/plans.txt";
