...
public abstract class AbstractTimer extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractTimer(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/timer/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/timer/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		temporaryStr = "\"timer INITIALIZED\"";
	    ...
	    public boolean startTo() throws Exception{	//public to allow reflection
	    try{
	    	int nPlanIter = 0;
	    ...
	    return returnValue;
	       ...
	       //println( getName() + " plan=startTo WARNING:" + e.getMessage() );
	       QActorContext.terminateQActorSystem(this); 
	       return false;  
	    }
	    }
