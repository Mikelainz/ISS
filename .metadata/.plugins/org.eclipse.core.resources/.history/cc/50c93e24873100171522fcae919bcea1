%==============================================
% WorldTheory.pl for actor iotled
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuiotled).	%%old version (deprecated)
actorobj(qatuiotled).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor iotled
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of iotled" ). 
...
%-------------------------------------------------
%  User static rules about iotled
%------------------------------------------------- 
/*
------------------------------------------------------------------------
