...
public abstract class AbstractControloop extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractControloop(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/controloop/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/controloop/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		temporaryStr = "\"controloop  STARTS\"";
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		//parg = "actorOp(createGuiButton(24))"; //JUNE2017
	    		parg = "createGuiButton(24)";
	    		...
	    		//parg = "actorOp(createGuiLed(25))"; //JUNE2017
	    		parg = "createGuiLed(25)";
	    		//ex solveGoalReactive JUNE2017
	    		aar = actorOpExecuteReactive(parg,3600000,"","");
	    		//println(getName() + " plan " + curPlanInExec  +  " interrupted=" + aar.getInterrupted() + " action goon="+aar.getGoon());
	    		if( aar.getInterrupted() ){
