...
public abstract class AbstractButtongpio extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractButtongpio(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/buttongpio/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/buttongpio/plans.txt";
