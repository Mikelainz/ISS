%==============================================
% WorldTheory.pl for actor controloop
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontroloop).	%%old version (deprecated)
actorobj(qatucontroloop).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor controloop
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of controloop" ). 
...
%-------------------------------------------------
%  User static rules about controloop
%------------------------------------------------- 
/*
------------------------------------------------------------------------
