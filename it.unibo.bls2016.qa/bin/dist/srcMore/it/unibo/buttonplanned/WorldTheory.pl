%==============================================
% WorldTheory.pl for actor buttonplanned
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubuttonplanned).	%%old version (deprecated)
actorobj(qatubuttonplanned).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor buttonplanned
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of buttonplanned" ). 
...
%-------------------------------------------------
%  User static rules about buttonplanned
%------------------------------------------------- 
/*
------------------------------------------------------------------------
