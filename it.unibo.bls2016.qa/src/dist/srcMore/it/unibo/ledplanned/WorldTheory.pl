%==============================================
% WorldTheory.pl for actor ledplanned
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledplanned).	%%old version (deprecated)
actorobj(qatuledplanned).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledplanned
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledplanned" ). 
...
%-------------------------------------------------
%  User static rules about ledplanned
%------------------------------------------------- 
/*
------------------------------------------------------------------------
