%==============================================
% WorldTheory.pl for actor iotbutton
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuiotbutton).	%%old version (deprecated)
actorobj(qatuiotbutton).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor iotbutton
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of iotbutton" ). 
...
%-------------------------------------------------
%  User static rules about iotbutton
%------------------------------------------------- 
/*
------------------------------------------------------------------------
