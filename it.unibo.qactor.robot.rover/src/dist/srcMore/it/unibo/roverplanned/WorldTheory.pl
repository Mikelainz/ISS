%==============================================
% WorldTheory.pl for actor roverplanned
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturoverplanned).	%%old version (deprecated)
actorobj(qaturoverplanned).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor roverplanned
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of roverplanned" ). 
...
%-------------------------------------------------
%  User static rules about roverplanned
%------------------------------------------------- 
/*
------------------------------------------------------------------------
