%==============================================
% WorldTheory.pl for actor controller017
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontroller017).	%%old version (deprecated)
actorobj(qatucontroller017).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor controller017
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of controller017" ). 
...
%-------------------------------------------------
%  User static rules about controller017
%------------------------------------------------- 
/*
------------------------------------------------------------------------
