%==============================================
% WorldTheory.pl for actor button017
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubutton017).	%%old version (deprecated)
actorobj(qatubutton017).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor button017
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of button017" ). 
...
%-------------------------------------------------
%  User static rules about button017
%------------------------------------------------- 
/*
------------------------------------------------------------------------
