%==============================================
% WorldTheory.pl for actor led017
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuled017).	%%old version (deprecated)
actorobj(qatuled017).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor led017
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of led017" ). 
...
%-------------------------------------------------
%  User static rules about led017
%------------------------------------------------- 
/*
------------------------------------------------------------------------
