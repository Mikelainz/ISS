%==============================================
% WorldTheory.pl for actor sonarmqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarmqtt).	%%old version (deprecated)
actorobj(qatusonarmqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarmqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarmqtt" ). 
...
%-------------------------------------------------
%  User static rules about sonarmqtt
%------------------------------------------------- 
onRaspberry.
...
p( 60,90).
p( 80,100).
obstacledata( p( D,90)):-retract( actorOpDone( _,d( D))),eval( gt,D,5),eval( lt,D,100).
/*
------------------------------------------------------------------------
