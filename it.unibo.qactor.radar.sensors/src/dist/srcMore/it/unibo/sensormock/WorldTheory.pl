%==============================================
% WorldTheory.pl for actor sensormock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusensormock).	%%old version (deprecated)
actorobj(qatusensormock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sensormock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sensormock" ). 
...
%-------------------------------------------------
%  User static rules about sensormock
%------------------------------------------------- 
p( 75,0).
p( 75,20).
p( 75,40).
