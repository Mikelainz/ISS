%==============================================
% WorldTheory.pl for actor qastepper
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqastepper).	%%old version (deprecated)
actorobj(qatuqastepper).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qastepper
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qastepper" ). 
...
%-------------------------------------------------
%  User static rules about qastepper
%------------------------------------------------- 
onRaspberry.
data( 1,stepper,p( 0)).
data( 2,stepper,p( 0)).
...
data( 8,stepper,p( 90)).
data( 9,stepper,p( 90)).
data( 10,stepper,p( 90)).
data( 11,stepper,p( 90)).
data( 12,stepper,p( 90)).
data( 13,stepper,p( 180)).
data( 14,stepper,p( 180)).
data( 15,stepper,p( 180)).
data( 16,stepper,p( 180)).
data( 17,stepper,p( 180)).
data( 18,stepper,p( 180)).
/*
------------------------------------------------------------------------
