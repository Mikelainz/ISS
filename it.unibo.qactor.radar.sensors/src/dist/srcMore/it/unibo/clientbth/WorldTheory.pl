%==============================================
% WorldTheory.pl for actor clientbth
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclientbth).	%%old version (deprecated)
actorobj(qatuclientbth).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clientbth
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clientbth" ). 
...
%-------------------------------------------------
%  User static rules about clientbth
%------------------------------------------------- 
/*
------------------------------------------------------------------------
