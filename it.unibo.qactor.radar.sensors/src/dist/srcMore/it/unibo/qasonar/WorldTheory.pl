%==============================================
% WorldTheory.pl for actor qasonar
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqasonar).	%%old version (deprecated)
actorobj(qatuqasonar).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qasonar
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qasonar" ). 
...
%-------------------------------------------------
%  User static rules about qasonar
%------------------------------------------------- 
onRaspberry.
data( 1,distance,d( 16)).
data( 2,distance,d( 32)).
data( 3,distance,d( 50)).
data( 4,distance,d( 60)).
data( 5,distance,d( 70)).
data( 6,distance,d( 80)).
data( 7,distance,d( 16)).
data( 8,distance,d( 32)).
data( 9,distance,d( 50)).
data( 10,distance,d( 60)).
data( 11,distance,d( 70)).
data( 12,distance,d( 80)).
data( 13,distance,d( 16)).
data( 14,distance,d( 32)).
data( 15,distance,d( 50)).
data( 16,distance,d( 60)).
data( 17,distance,d( 70)).
data( 18,distance,d( 80)).
/*
------------------------------------------------------------------------
