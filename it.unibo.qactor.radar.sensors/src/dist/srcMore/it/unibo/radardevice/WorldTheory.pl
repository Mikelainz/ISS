%==============================================
% WorldTheory.pl for actor radardevice
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadardevice).	%%old version (deprecated)
actorobj(qaturadardevice).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radardevice
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radardevice" ). 
...
%-------------------------------------------------
%  User static rules about radardevice
%------------------------------------------------- 
/*
------------------------------------------------------------------------
