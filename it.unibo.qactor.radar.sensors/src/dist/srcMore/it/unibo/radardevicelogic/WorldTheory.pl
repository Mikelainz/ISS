%==============================================
% WorldTheory.pl for actor radardevicelogic
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadardevicelogic).	%%old version (deprecated)
actorobj(qaturadardevicelogic).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radardevicelogic
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radardevicelogic" ). 
...
%-------------------------------------------------
%  User static rules about radardevicelogic
%------------------------------------------------- 
p( 75,0).
p( 75,20).
p( 75,40).
