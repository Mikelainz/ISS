%==============================================
% WorldTheory.pl for actor radarguilogic
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadarguilogic).	%%old version (deprecated)
actorobj(qaturadarguilogic).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radarguilogic
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radarguilogic" ). 
...
%-------------------------------------------------
%  User static rules about radarguilogic
%------------------------------------------------- 
/*
------------------------------------------------------------------------
