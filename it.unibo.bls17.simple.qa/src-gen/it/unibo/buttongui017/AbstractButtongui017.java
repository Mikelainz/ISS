...
public abstract class AbstractButtongui017 extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractButtongui017(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/buttongui017/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/buttongui017/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		//parg = "actorOp(createButton)"; //JUNE2017
	    		parg = "createButton";
	    		...
	    		temporaryStr = "\"	buttonsimple017 ENDS\"";
