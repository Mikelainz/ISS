%==============================================
% WorldTheory.pl for actor ledsimple017
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledsimple017).	%%old version (deprecated)
actorobj(qatuledsimple017).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledsimple017
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledsimple017" ). 
...
%-------------------------------------------------
%  User static rules about ledsimple017
%------------------------------------------------- 
/*
------------------------------------------------------------------------
