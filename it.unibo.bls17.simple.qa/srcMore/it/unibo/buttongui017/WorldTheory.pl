%==============================================
% WorldTheory.pl for actor buttongui017
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubuttongui017).	%%old version (deprecated)
actorobj(qatubuttongui017).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor buttongui017
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of buttongui017" ). 
...
%-------------------------------------------------
%  User static rules about buttongui017
%------------------------------------------------- 
/*
------------------------------------------------------------------------
