%==============================================
% WorldTheory.pl for actor flashled
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuflashled).	%%old version (deprecated)
actorobj(qatuflashled).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor flashled
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of flashled" ). 
...
%-------------------------------------------------
%  User static rules about flashled
%------------------------------------------------- 
/*
------------------------------------------------------------------------
