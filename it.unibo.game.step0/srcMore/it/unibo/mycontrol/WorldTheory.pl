%==============================================
% WorldTheory.pl for actor mycontrol
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumycontrol).	%%old version (deprecated)
actorobj(qatumycontrol).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mycontrol
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mycontrol" ). 
...
%-------------------------------------------------
%  User static rules about mycontrol
%------------------------------------------------- 
/*
------------------------------------------------------------------------
