%==============================================
% WorldTheory.pl for actor roverreactor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturoverreactor).	%%old version (deprecated)
actorobj(qaturoverreactor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor roverreactor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of roverreactor" ). 
...
%-------------------------------------------------
%  User static rules about roverreactor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
