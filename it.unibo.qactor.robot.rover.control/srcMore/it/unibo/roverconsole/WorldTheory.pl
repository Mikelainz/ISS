%==============================================
% WorldTheory.pl for actor roverconsole
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturoverconsole).	%%old version (deprecated)
actorobj(qaturoverconsole).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor roverconsole
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of roverconsole" ). 
...
%-------------------------------------------------
%  User static rules about roverconsole
%------------------------------------------------- 
no_usercontrol.
speedMap( low,10).
speedMap( medium,40).
...
cmdToMove( move( DIRECTION,VELOCITY,TIME,ANGLE)):-retract( msg( usercmd,_,SENDER,none,usercmd( robotgui( CMD)),SEQNUM)),moveMap( CMD,DIRECTION,VELOCITY,ANGLE,TIME),output( cmdToMoveeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee( DIRECTION,VELOCITY,TIME,ANGLE)).
moveToCmd( usercmd( R)):-retract( msg( inputcmd,_,SENDER,none,usercmd( executeInput( move( D,S,T,A))),SEQNUM)),mapToGuiCmd( move( D,S,T,A),R),output( usercmdddddddddddddddddddddddddddddddddddddd( R)).
/*
------------------------------------------------------------------------
